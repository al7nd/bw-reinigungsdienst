            ...
            <section>
              ...
              <div className="bg-gray-50 p-6 rounded-xl">
                <p className="text-gray-600">
                  ...
                  <span className="flex items-center gap-2 mt-2"><Mail size={16} className="text-blue-600" /><a href="mailto:info@bwreinigungsdienst.de" className="text-blue-600 hover:underline">info@bwreinigungsdienst.de</a></span>
