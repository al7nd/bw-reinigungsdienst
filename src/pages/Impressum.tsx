          ...
          <div className="space-y-8">
            ...
            <section>
              ...
              <div className="grid md:grid-cols-2 gap-4">
                ...
                <a href="mailto:info@bw-reinigungsdienst.de" className="flex items-center gap-3 p-4 bg-gray-50 rounded-xl hover:bg-blue-50"><Mail className="text-blue-600" size={20} /><span className="text-gray-700">info@bw-reinigungsdienst.de</span></a>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="flex items-center gap-3 p-4 bg-blue-50 rounded-xl">
                ...
                <span className="text-blue-600 font-medium">bw-reinigungsdienst.de</span>
              </div>
            </section>
