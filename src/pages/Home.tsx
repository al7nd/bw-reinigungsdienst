...
export default function Home() {
  ...
  const testimonials = [
    { name: 'Edris Z.', location: 'Herne', rating: 4.9, text: 'Nach einem Wasserschaden waren die Arbeiter in weniger als 2 Stunden am Einsatzort. Kann ich nur weiter empfehlen!' },
